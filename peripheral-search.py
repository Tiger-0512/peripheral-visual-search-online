...
image_1_0 = visual.ImageStim(
    ...
    ori=0.0, pos=(0, 0), size=(2 * deg2norm, 2 * deg2norm),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image_2_0 = visual.ImageStim(
    ...
    ori=0.0, pos=(0, 0), size=(2 * 2 * deg2norm, 2 * 2 * deg2norm),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
for i in range(len(image_list)):
    if i < 4:
        image_list[i].pos = (
            deg2norm * eccentricity_level_1 * math.cos(math.radians(i % 4 * 90 + 45)),
            deg2norm * eccentricity_level_1 * math.sin(math.radians(i % 4 * 90 + 45))
        )
    elif 4 <= i < 8:
        image_list[i].pos = (
            deg2norm * eccentricity_level_2 * math.cos(math.radians(i % 4 * 90)),
            deg2norm * eccentricity_level_2 * math.sin(math.radians(i % 4 * 90))
        )
    else:
        image_list[i].pos = (
            deg2norm * eccentricity_level_3 * math.cos(math.radians(i % 4 * 90 + 45)),
