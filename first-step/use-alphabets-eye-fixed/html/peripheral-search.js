...
function experimentInit() {
  ...
  alphabet_0_0 = new visual.TextStim({
    win: psychoJS.window,
    name: 'alphabet_0_0',
    text: '',
    font: 'Open Sans',
  ...
  alphabet_0_1 = new visual.TextStim({
    win: psychoJS.window,
    name: 'alphabet_0_1',
    text: '',
    font: 'Open Sans',
  ...
  alphabet_0_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'alphabet_0_2',
    text: '',
    font: 'Open Sans',
  ...
  alphabet_0_3 = new visual.TextStim({
    win: psychoJS.window,
    name: 'alphabet_0_3',
    text: '',
    font: 'Open Sans',
  ...
  alphabet_1_0 = new visual.TextStim({
    win: psychoJS.window,
    name: 'alphabet_1_0',
    text: '',
    font: 'Open Sans',
  ...
  alphabet_1_1 = new visual.TextStim({
    win: psychoJS.window,
    name: 'alphabet_1_1',
    text: '',
    font: 'Open Sans',
  ...
  alphabet_1_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'alphabet_1_2',
    text: '',
    font: 'Open Sans',
  ...
  alphabet_1_3 = new visual.TextStim({
    win: psychoJS.window,
    name: 'alphabet_1_3',
    text: '',
    font: 'Open Sans',
  ...
  alphabet_2_0 = new visual.TextStim({
    win: psychoJS.window,
    name: 'alphabet_2_0',
    text: '',
    font: 'Open Sans',
    units: undefined, 
    pos: [0, 0], height: 2*2*an2pix,  wrapWidth: undefined, ori: 0.0,
    color: new util.Color('white'),  opacity: undefined,
    depth: -11.0 
  });
  
  alphabet_2_1 = new visual.TextStim({
    win: psychoJS.window,
    name: 'alphabet_2_1',
    text: '',
    font: 'Open Sans',
  ...
  alphabet_2_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'alphabet_2_2',
    text: '',
    font: 'Open Sans',
  ...
  alphabet_2_3 = new visual.TextStim({
    win: psychoJS.window,
    name: 'alphabet_2_3',
    text: '',
    font: 'Open Sans',
...
function expIntroRoutineBegin(snapshot) {
  return function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    alphabet_list = [alphabet_0_0, alphabet_0_1, alphabet_0_2, alphabet_0_3, alphabet_1_0, alphabet_1_1, alphabet_1_2, alphabet_1_3, alphabet_2_0, alphabet_2_1, alphabet_2_2, alphabet_2_3];
    
    for (var i = 0, _pj_a = alphabet_list.length; (i < _pj_a); i += 1) {
        if (i < 4) {
            alphabet_list[i].pos = [
    ...
    // keep track of which components have finished
    expIntroComponents = [];
    expIntroComponents.push(alphabet_0_0);
    expIntroComponents.push(alphabet_0_1);
    expIntroComponents.push(alphabet_0_2);
    expIntroComponents.push(alphabet_0_3);
    expIntroComponents.push(alphabet_1_0);
    expIntroComponents.push(alphabet_1_1);
    expIntroComponents.push(alphabet_1_2);
    expIntroComponents.push(alphabet_1_3);
    expIntroComponents.push(alphabet_2_0);
    expIntroComponents.push(alphabet_2_1);
    expIntroComponents.push(alphabet_2_2);
    expIntroComponents.push(alphabet_2_3);
    ...
    for (const thisComponent of expIntroComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function expIntroRoutineEachFrame(snapshot) {
  return function () {
    ...
    if (t >= 0.0 && alphabet_0_0.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      alphabet_0_0.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && alphabet_0_1.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      alphabet_0_1.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && alphabet_0_2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      alphabet_0_2.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && alphabet_0_3.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      alphabet_0_3.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && alphabet_1_0.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      alphabet_1_0.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && alphabet_1_1.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      alphabet_1_1.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && alphabet_1_2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      alphabet_1_2.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && alphabet_1_3.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      alphabet_1_3.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && alphabet_2_0.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      alphabet_2_0.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && alphabet_2_1.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      alphabet_2_1.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && alphabet_2_2.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      alphabet_2_2.tStart = t;  // (not accounting for frame time here)
    ...
    if (t >= 0.0 && alphabet_2_3.status === PsychoJS.Status.NOT_STARTED) {
      // keep track of start time/frame for later
      alphabet_2_3.tStart = t;  // (not accounting for frame time here)
    ...
    if ((intro_state === 1)) {
        introduction_text.text = "Click the center circle to display a lineup of alphabets.";
    ...
    if ((intro_state === 2)) {
        introduction_text.text = "You find \"N\" \n in 200 milliseconds.";
...
function practiceIntroRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of practiceIntroComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
  ...
  return function () {
    ...
    for (var i = 0, _pj_a = alphabet_list.length; (i < _pj_a); i += 1) {
        ...
        if ((4 <= i) && (i < 8)) {
            ...
            if (i >= 8) {
                alphabet_list[i].height = Math.pow(rate, 2) * alphabet_list[i].height;
            }
        }
    }
...
function showStimRoutineEachFrame(snapshot) {
  return function () {
    ...
    if (showStimClock.getTime() > 0.2) {
        for (var i = 0, _pj_a = alphabet_list.length; (i < _pj_a); i += 1) {
            alphabet_list[i].setAutoDraw(true);
        }
    }
    ...
    if (fake_key_resp.status === PsychoJS.Status.STARTED) {
      let theseKeys = fake_key_resp.getKeys({keyList: ['space'], waitRelease: false});
...
function showStimRoutineEnd(snapshot) {
  return function () {
    ...
    for (var i = 0, _pj_a = alphabet_list.length; (i < _pj_a); i += 1) {
        alphabet_list[i].setAutoDraw(false);
    }
    fake_key_resp.stop();
...
function brankRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of brankComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function showFeedbackRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of showFeedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function publishSurveyCodeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of publishSurveyCodeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
