...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/tiger/Scripts_GoogleDrive/research/pavlovia/peripheral-visual-search-alp-eye-fixed/peripheral-search_lastrun.py',
...
# keep track of which components have finished
expIntroComponents = [alphabet_0_0, alphabet_0_1, alphabet_0_2, alphabet_0_3, alphabet_1_0, alphabet_1_1, alphabet_1_2, alphabet_1_3, alphabet_2_0, alphabet_2_1, alphabet_2_2, alphabet_2_3, stimuli_arrangement, ans_0_0, ans_0_1, ans_0_2, ans_0_3, ans_1_0, ans_1_1, ans_1_2, ans_1_3, ans_2_0, ans_2_1, ans_2_2, ans_2_3, fixation_point, introduction_text, back_text]
...
for thisPracticeTrial in PracticeTrials:
    ...
    while continueRoutine:
        ...
        if fake_key_resp.status == STARTED and not waitOnFlip:
            theseKeys = fake_key_resp.getKeys(keyList=['space'], waitRelease=False)
