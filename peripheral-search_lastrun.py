...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/tiger/Scripts_GoogleDrive/research/peripheral-visual-search/peripheral-search_lastrun.py',
...
# Set experiment start values for variable component window_y
window_y = ''
window_yContainer = []
# Set experiment start values for variable component window_x
window_x = ''
window_xContainer = []
for mon in psychopy.monitors.getAllMonitors():
    window_x, window_y = psychopy.monitors.Monitor(mon).getSizePix()
text_3 = visual.TextStim(win=win, name='text_3',
    text=window_x,
    font='Open Sans',
    units='pix', pos=(0, 0), height=1.0, wrapWidth=None, ori=0.0, 
...
_key_resp_3_allKeys = []
# keep track of which components have finished
testComponents = [text_3, key_resp_3]
